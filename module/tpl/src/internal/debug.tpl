...
{if isset($_templatelite_debug_output) and $_templatelite_debug_output eq "html"}
	...
	<tr bgcolor=#cccccc><th colspan=2>Simpla Debug Console</th></tr>
	...
	{foreach key=key value=vars from=$_debug_keys}
		...
		{if $_debug_keys[$key] != "_templatelite_debug_output"}
			<tr bgcolor={if $key % 2}#eeeeee{else}#fafafa{/if}>
...
<SCRIPT language=javascript>
	...
	_templatelite_console.document.write("<HTML><TITLE>Simpla Debug Console_"+self.name+"</TITLE><BODY bgcolor=#ffffff>");
	_templatelite_console.document.write("<table border=0 width=100%>");
	_templatelite_console.document.write("<tr bgcolor=#cccccc><th colspan=2>Simpla Debug Console</th></tr>");
