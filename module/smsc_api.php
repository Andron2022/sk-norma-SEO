<?php
// SMSC.RU API (smsc.ru) версия 3.5 (18.12.2016) modified for Simpla! 10.01.2017

// логин и пароль задаются в файле config.php
if (!defined('SMSC_LOGIN')) { define('SMSC_LOGIN', '0'); }
if (!defined('SMSC_PASSWORD')) { define('SMSC_PASSWORD', '0'); } // пароль или MD5-хеш пароля в нижнем регистре
...
if(SMSC_LOGIN == '0' || SMSC_PASSWORD == '0'){
	return '';
}
