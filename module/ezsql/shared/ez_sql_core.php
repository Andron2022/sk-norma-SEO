...
//echo time();
			...
			echo "<font face=arial size=2 color=000099><b>Query</b> [$this->num_queries] <b>- ";
			if($this->num_queries > 1){
				echo round($this->timers[$this->num_queries]-$this->timers[$this->num_queries-1],3);
				echo ' sec.';
			}			
			echo " -</b> ";
			echo "<pre>[<font color=000000><b>$this->last_query</b></font>]</pre></font><p>";
