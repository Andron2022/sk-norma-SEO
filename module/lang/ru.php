...
$lang['comment'] = array('Отзыв', 'Отзыва', 'Отзывов');
$lang['ordercomment'] = array('Комментарий', 'Комментария', 'Комментариев');

$lang['search'] = array(
    'search' => 'Поиск',
    'title' => 'Поиск по сайту',
    'metatitle' => 'Результаты поиска по сайту',
    'search_for' => 'Вы искали:',
    'search_results' => 'Результаты поиска:',
    'nothing_found' => 'По вашему запросу ничего не найдено',
    'products' => 'Предложения',
    'pubs' => 'Публикации',
    'categs' => 'Страницы',
    'empty_query_string' => 'Введите запрос для поиска по сайту',
);
...
$lang['feedback'] = array(
	'title' => array( 
		'contact' => 'Контактная форма', // контактная форма
		'request' => 'Форма запроса' // форма запроса
	),
    'view' => array(
        'title' => 'Запрос №-%s',
        'metatitle' => 'Запрос №-%s',
    ...
    'sent' => array(
        ...
        'metatitle' => 'Сообщение успешно отправлено',
        'content' => 'Спасибо за сообщение. Мы ответим в ближайшее рабочее время. %s', 
        'body' => 'Запрос №-%s успешно отправлен',
        'subject' => 'Запрос №-%s',
        'new' => 'Новый запрос №-%s',
    ...
    'notify' => 'Уведомление',
    'phone' => 'Телефон',
    'phone_example' => '+7123456789',
    'your_phone' => '+7123456789',
    'name' => 'Имя',
	'your_name' => 'Ваше имя',
    'message' => 'Сообщение',
    'message_example' => 'Ваше сообщение',
...
$lang['words'] = array(
	...
	'search' => 'Поиск', // искать
	'contact_us' => 'Контакты', //
	'sitemap' => 'Карта сайта', // карта сайта
	'site_search' => 'Поиск по сайту', //Поиск по сайту
	'your_request' => 'Вы искали', //Вы искали
	'search_results' => 'Результаты поиска', //Результаты поиска
	'last_news' => 'Новости', // Последние новости
	'tag' => 'Тег', //tag
	'tags' => 'Теги', //tags
	'socialnets' => 'Социальные сети', // социальные сети
	'address' => 'Адрес', // адрес
	'files' => 'Файлы', // Файлы
	'file' => 'Файл', // Файл
