...
document.getElementById("menu132").onmouseout = function() { this.className = ""; }
...
document.getElementById("menu147").onmouseout = function() { this.className = ""; }
}}
//TransMenu.spacerGif = "modules/mod_swmenufree/images/transmenu/x.gif";
//TransMenu.dingbatOn = "modules/mod_swmenufree/images/transmenu/whiteleft-on.gif";
//TransMenu.dingbatOff = "modules/mod_swmenufree/images/transmenu/whiteleft-off.gif"; 
...
TransMenu.backgroundColor = "#444444";
...
function changePod(v) {
    if (v == 0) podok = false;
    else podok = true;
    total();
}

function changeMonRob(v) {
    if (v == 0) monRob = false;
    else monRob = true;
    total();
}
...
$(function() {
    ...
    function refreshSwatch() {
        $('.slider1-val').val($('#slider1').slider('value'));
        total();
    }

    function refreshSwatch2() {
        $('.slider2-val').val($('#slider2').slider('value'));
        total();
    }
...
function total() {
    ...
    var square = $('.slider2-val').val() * $('.slider1-val').val();
    var total = 0;

    if (type_glob == 1) {
        total += square / (100 * 100) * 3692;
    }

    if (type_glob == 2) {
        total += square / (100 * 100) * 4245;
    }

    if (type_glob == 3) {
        total += square / (100 * 100) * 4578;
    }
    ...
    if (podok == true) total += square / (100 * 100) * 540;
    if (monRob == true) total += square / (100 * 100) * 540;
