...
function updateSize(obj) { obj.onResize(obj.resizer.clientWidth, obj.resizer.clientHeight); }
...
function getContainer(container_id)
{
	...
	//	   return container;
		...
		//if you're in a constructor
                // Для старого конструктора
		if(document.getElementById('site_place') != undefined)
		{
