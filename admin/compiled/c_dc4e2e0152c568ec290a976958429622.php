...
<h1 class="mt-0"><?php echo GetMessageTpl(array('key1' => "admin",'key2' => "prava",'key3' => "payments"), $this);?></h1>
...
<form method="get">
    ...
    <select name="" onchange="top.location=this.value">
		<option value="?action=settings&do=payments"> - <?php echo GetMessageTpl(array('key1' => "admin",'key2' => "fb",'key3' => "all_sites"), $this);?></option>
		<?php if (count((array)$this->_vars['site_vars']['list_sites'])): foreach ((array)$this->_vars['site_vars']['list_sites'] as $this->_vars['v']): ?>
			<option value="?action=settings&do=payments&site_id=<?php echo $this->_vars['v']['id']; ?>
...
<?php if (! empty ( $this->_vars['list_payments'] )): ?>
	<table width="80%">
		<tr>
			<th>ID</th>
		...
		<?php if (count((array)$this->_vars['list_payments'])): foreach ((array)$this->_vars['list_payments'] as $this->_vars['v']): ?>
...
<?php endif; ?>          
	...
	<p><a href="?action=settings&do=payments&id=0"><i class="fa fa-plus"></i> <?php echo GetMessageTpl(array('key1' => "admin",'key2' => "add"), $this);?></a></p>
