<?php require_once('/home/sk-norma/sk-norma.ru/docs/module/tpl/src/plugins/modifier.int.php'); $this->register_modifier("int", "tpl_modifier_int");  require_once('/home/sk-norma/sk-norma.ru/docs/module/tpl/src/plugins/function.cycle.php'); $this->register_function("cycle", "tpl_function_cycle");   if (! empty ( $this->_vars['page']['blocks']['manual'] )): ?>
