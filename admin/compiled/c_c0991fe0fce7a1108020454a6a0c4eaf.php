<?php require_once('/var/www/u1126524/data/www/sk-norma.ru/module/tpl/src/plugins/modifier.date.php'); $this->register_modifier("date", "tpl_modifier_date");  ?>									
                        ...
                        <div class="">
                            <div class="row m-0 p-0">
								<div class="col-md-6 col-sm-6 col-xs-12 footer-block left m-0 p-0">
                                    © 2010-<?php echo $this->_run_modifier(time(), 'date', 'plugin', 1, "Y"); ?>
...
<?php echo $this->_vars['site']['B24']; ?>

<?php echo $this->_vars['site']['B24_mail_track']; ?>
