<?php require_once('/var/www/u1126524/data/www/sk-norma.ru/module/tpl/src/plugins/modifier.int.php'); $this->register_modifier("int", "tpl_modifier_int");   if (! empty ( $this->_vars['page']['blocks']['manual'] )): ?>
