<?php require_once('/home/sk-norma/new.sk-norma.ru/docs/module/tpl/src/plugins/function.img.php'); $this->register_function("img", "tpl_function_img");  require_once('/home/sk-norma/new.sk-norma.ru/docs/module/tpl/src/plugins/modifier.replace.php'); $this->register_modifier("replace", "tpl_modifier_replace");  require_once('/home/sk-norma/new.sk-norma.ru/docs/module/tpl/src/plugins/modifier.escape.php'); $this->register_modifier("escape", "tpl_modifier_escape");  ?><!DOCTYPE html>
...
<?php else: ?>
	<?php $this->assign('top_email', "sknorma@irline.su");  endif; ?>
...
<?php if (! empty ( $this->_vars['page']['list_photos'] ) && ! empty ( $_GET['id'] )):  $this->assign('gid', $_GET['id']);  else:  $this->assign('gid', "");  endif; ?>

<?php if (empty ( $this->_vars['site']['img_mainslider_height']['value'] )): ?>
	<?php $this->assign('height', 410);  else: ?>
	<?php $this->assign('height', $this->_vars['site']['img_mainslider_height']['value']);  endif; ?>
