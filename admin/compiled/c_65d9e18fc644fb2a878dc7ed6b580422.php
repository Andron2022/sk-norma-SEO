<?php require_once('/home/sk-norma/sk-norma.ru/docs/module/tpl/src/plugins/modifier.date.php'); $this->register_modifier("date", "tpl_modifier_date");  ?>									
...
<?php echo $this->_vars['site']['jivik']; ?>

<?php echo $this->_vars['site']['CalltouchAPIJivik']; ?>
